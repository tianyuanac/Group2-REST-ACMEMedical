...
public class PojoListener {
	...
	public void setCreatedOnDate(PojoBase pojoBase) {
		...
		pojoBase.setCreated(now); // Set created timestamp
		pojoBase.setUpdated(now); // Set updated timestamp to the same value as created
	}
	...
	public void setUpdatedDate(PojoBase pojoBase) {
		...
		pojoBase.setUpdated(LocalDateTime.now()); // Update the updated timestamp
	}
